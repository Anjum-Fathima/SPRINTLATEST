...
public class MenuUtil 
{
	...
	boolean result;
	public void start() throws InsufficientExperienceException, InsufficientHoursOfAvailabilityException 
	{
		...
		case 3 :
			...
			case 3 :
				...
				sc.nextLine();
				Patient patient1 = new Patient();
				FinanceDAO financeDAO1 = new FinanceDAOImpl();
             	PatientDAO patientDAO1 = new PatientDAOImpl();
				List<Patient> patients1 = patientDAO1.getAllPatientDetails();
				...
				try {
					financeDAO1.updateFee(patient1.getPatientId(),amount);
				} catch (PatientFinanceDetailsNotFoundException e) {
			...
			case 4 :
				...
				FinanceDAO financeDAO2 = new FinanceDAOImpl();
             	PatientDAO patientDAO2 = new PatientDAOImpl();
				List<Patient> patients3 = patientDAO2.getAllPatientDetails();
			...
			case 5 :
				...
				List<Finance> finances = financeDAO3.findAll();
